...
- "PSI" IS ALWAYS UPPERCASE, everywhere, including inside brackets: write "PSI" and "(PSI)", never "psi" or "(psi)". It is the name of our system, so it never lowercases, even mid-sentence.
